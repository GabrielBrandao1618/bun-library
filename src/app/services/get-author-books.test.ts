...
describe("Get author books tests", () => {
  it("Should get all author's books", async () => {
    ...
    await repo.create(new Book("aaaa", "A book", "aaaa", 65));
    await repo.create(new Book("bbbb", "A book - prequel", "aaaa", 67));
    await repo.create(new Book("cccc", "A random book", "bbbb", 60));
